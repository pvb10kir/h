...
return msg
	...
	if lock_cmd == "yes" and is_cmd(msg.text) and not is_momod(msg) then
			...
			local is_link_msg = msg.text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.text:match("[Tt].[Mm][Ee]/")
			...
			local is_url_msg = msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Tt].[Mm][Ee]/") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]") or msg.text:match(".[Ii][Nn][Ff][Oo]") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Tt][Kk]")
		...
		if msg.media then -- msg.media checks
			...
			if is_tag_title and lock_tag == "yes" then
				...
				local is_url_title = msg.media.title:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.media.title:match("[Tt].[Mm][Ee]/") or msg.media.title:match("[Hh][Tt][Tt][Pp]://") or msg.media.title:match(".[Ii][Rr]") or msg.media.title:match(".[Cc][Oo][Mm]") or msg.media.title:match(".[Oo][Rr][Gg]") or msg.media.title:match(".[Ii][Nn][Ff][Oo]") or msg.media.title:match("[Ww][Ww][Ww].") or msg.media.title:match(".[Tt][Kk]")
			...
			if is_emoji_title and lock_emoji == "yes" then
				...
				local is_link_title = msg.media.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.media.title:match("[Tt].[Mm][Ee]/") or msg.media.title:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
			...
			if is_tag_desc and lock_tag == "yes" then
				...
				local is_url_desc = msg.media.description:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.media.description:match("[Tt].[Mm][Ee]/") or msg.media.description:match("[Hh][Tt][Tt][Pp]://") or msg.media.description:match(".[Ii][Rr]") or msg.media.description:match(".[Cc][Oo][Mm]") or msg.media.description:match(".[Oo][Rr][Gg]") or msg.media.description:match(".[Ii][Nn][Ff][Oo]") or msg.media.description:match("[Ww][Ww][Ww].") or msg.media.description:match(".[Tt][Kk]")
			...
			if is_emoji_desc and lock_emoji == "yes" then
				...
				local is_link_desc = msg.media.description:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or  msg.media.description:match("[Tt].[Mm][Ee]/") or msg.media.description:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
			...
			if is_emoji_caption and lock_emoji == "yes" then
				...
				local is_link_caption = msg.media.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or  msg.media.caption:match("[Tt].[Mm][Ee]/") or msg.media.caption:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
		...
		if msg.fwd_from then
			if msg.fwd_from.title then
				local is_link_title = msg.fwd_from.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.fwd_from.title:match("[Tt].[Mm][Ee]/") or msg.fwd_from.title:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
				if is_link_title and lock_link == "yes" then
					delete_msg(msg.id, ok_cb, false)
